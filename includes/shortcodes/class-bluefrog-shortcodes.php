...
class Bluefrog_Shortcodes {
	...
	public static function button( $atts ) {
		...
		if ( 'center' == $atts['align'] ) {
			return '<div class="bluefrog-button-wrapper text-center">' . $button . '</div>';
		}
			...
			'<div class="%s">
				<div class="banner-inner">
					...
					<div class="banner-content">
						...
						<a href="%s" target="%s" rel="%s" class="bluefrog-button button-light line-hover active">%s</a>
					</div>
				</div>
			</div>',
			esc_attr( implode( ' ', $css_class ) ),
	...
	public static function collection_carousel( $atts ) {
		...
		foreach ( $collections as $collection ) {
			...
			$list[] = '<div class="bluefrog-collection-carousel__item"><a ' . $href . '>' . $image . $title . $button . '</a></div>';
		}
